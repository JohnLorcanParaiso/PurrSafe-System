...
<div class="side-menu">
        <div class="text-center">
            <img src="../../3_Images/logo.png" class="logo" style="width: 150px; height: 150px; margin: 10px auto; display: block;">
        </div>
        <ul class="nav flex-column" style="gap: 5px;">
            <li class="nav-item">
                <form method="POST" style="margin: 0;">
                    <button type="submit" name="action" value="dashboard" class="btn btn-link nav-link text-dark active" style="padding: 8px 15px;">
            ...
            <li class="nav-item">
                <form method="POST" style="margin: 0;">
                    <button type="submit" name="action" value="create" class="btn btn-link nav-link text-dark" style="padding: 8px 15px;">
            ...
            <li class="nav-item">
                <form method="POST" style="margin: 0;">
                    <button type="submit" name="action" value="view" class="btn btn-link nav-link text-dark" style="padding: 8px 15px;">
            ...
            <li class="nav-item">
                <form method="POST" style="margin: 0;">
                    <button type="submit" name="action" value="myProfile" class="btn btn-link nav-link text-dark" style="padding: 8px 15px;">
            ...
            <li class="nav-item">
                <form method="POST" style="margin: 0;">
                    <button type="submit" name="action" value="help" class="btn btn-link nav-link text-dark" style="padding: 8px 15px;">
            ...
            <li class="nav-item">
                <form method="POST" style="margin: 0;">
                    <button type="submit" name="action" value="others" class="btn btn-link nav-link text-dark" style="padding: 8px 15px;">
            ...
            <li class="nav-item mt-auto">
                <form method="POST" style="margin: 0;">
                    <button type="submit" name="action" value="logout" class="btn btn-link nav-link text-dark" style="padding: 8px 15px;">
    ...
    <div class="container-custom" style="margin-top: 0; padding-top: 0;">
