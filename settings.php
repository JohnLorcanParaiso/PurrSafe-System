                                ...
                                <div class="accordion-body">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4 text-center">
                                            <div class="mb-2">
                                                <img src="images/developers/paraiso.jpg" class="rounded-circle" alt="Lorcan" 
                                        ...
                                        <div class="col-md-4 text-center">
                                            <div class="mb-2">
                                                <img src="images/developers/katigbak.jpg" class="rounded-circle" alt="Justin" 
                                                     style="width: 80px; height: 80px; object-fit: cover;">
                                            </div>
                                        ...
                                        <div class="col-md-4 text-center">
                                            <div class="mb-2">
                                                <img src="images/developers/madrid.jpg" class="rounded-circle" alt="Jaika" 
                                                     style="width: 80px; height: 80px; object-fit: cover;">
                                            </div>
